...
This project is indexed by GitNexus as **timorlist** (1906 symbols, 2950 relationships, 90 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
