...
This project is indexed by GitNexus as **timorlist** (1594 symbols, 2680 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
