...
This project is indexed by GitNexus as **timorlist** (3178 symbols, 4191 relationships, 115 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
