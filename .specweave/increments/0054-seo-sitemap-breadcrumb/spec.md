...
**Acceptance Criteria**:
- [x] **AC-US1-01**: `/sitemap.xml` returns valid XML with all public pages ✅
- [x] **AC-US1-02**: Sitemap includes static pages (homepage, about, contact, pricing, faq, blog) ✅
- [x] **AC-US1-03**: Sitemap includes business/non-profit/public-sector detail pages ✅
- [x] **AC-US1-04**: Sitemap includes lastmod timestamp for each entry ✅
- [x] **AC-US1-05**: Sitemap includes changefreq and priority based on page type ✅
...
**Acceptance Criteria**:
- [x] **AC-US2-01**: Business detail pages include BreadcrumbList JSON-LD ✅
- [x] **AC-US2-02**: Non-profit detail pages include BreadcrumbList JSON-LD ✅
- [x] **AC-US2-03**: Public sector detail pages include BreadcrumbList JSON-LD ✅
- [x] **AC-US2-04**: Product/SKU detail pages include BreadcrumbList JSON-LD ✅
- [ ] **AC-US2-05**: Blog article pages include BreadcrumbList JSON-LD ⚠️ (blog pages don't exist)
