...
- [x] **AC-US1-02**: role 枚举�?`user | editor | admin | super_admin`
- [x] **AC-US1-03**: phone 字段�?NOT NULL
- [x] **AC-US1-04**: email 字段�?OPTIONAL
- [x] **AC-US1-05**: 添加 emailVerified 布尔字段
- [x] **AC-US1-06**: 添加 lastLoginAt 时间戳字�?- [x] **AC-US1-07**: user 角色只能前端登录，无法访�?/admin (Deferred to AC-US1-07 implementation)
