...
id: US-002
feature: FS-014
title: "Display Icons on Homepage (P1)"
status: completed
priority: P1
...
**Increment**: [0014-category-icons-sync](../../../../../increments/0014-category-icons-sync/spec.md)
...
- [x] **T-005**: Update CategoryCard to display icons
