...
This project is indexed by GitNexus as **timorlist** (3301 symbols, 5020 relationships, 103 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
