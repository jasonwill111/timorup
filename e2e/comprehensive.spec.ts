...
test.describe('Mobile Responsiveness', () => {
  ...
  test('Mobile menu works', async ({ page }) => {
    ...
    const menuBtn = page.locator('#mobile-menu-btn, button:has-text("â˜?), button[aria-label="Open menu"]').first();
...
test.describe('Theme Toggle', () => {
  test('Theme toggle exists on homepage', async ({ page }) => {
    ...
    const themeBtn = page.locator('[data-testid="theme-toggle"], button[aria-label*="theme"], button:has-text("â˜€ï¸?), button:has-text("ðŸŒ™")').first();
