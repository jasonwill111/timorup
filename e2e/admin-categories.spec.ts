...
// ============================================
// Note: /api/admin/categories has GET (list), POST (create), PUT (update) - no DELETE
...
test.describe('Admin - Category Management', () => {
  ...
  // CT-007: Category entity type
  test('CT-007: should show entity type options', async ({ page }) => {
    await page.goto('/admin/categories');
  ...
  // CT-008: Category icon
  test('CT-008: should allow setting category icon', async ({ page }) => {
    await page.goto('/admin/categories');
