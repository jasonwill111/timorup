...
const $$Register = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Register - TIMORLIST" }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="container py-12"> <div class="max-w-md mx-auto"> ${renderComponent($$result2, "Card", $$Card, {}, { "default": ($$result3) => renderTemplate`
        ${renderComponent($$result3, "CardHeader", $$CardHeader, { "class": "text-center" }, { "default": ($$result4) => renderTemplate`
          ${renderComponent($$result4, "CardTitle", $$CardTitle, { "class": "text-2xl" }, { "default": ($$result5) => renderTemplate`Create an Account` })}
          ${renderComponent($$result4, "CardDescription", $$CardDescription, {}, { "default": ($$result5) => renderTemplate`Join TIMORLIST to promote your business` })}
        ` })}
        ${renderComponent($$result3, "CardContent", $$CardContent, {}, { "default": ($$result4) => renderTemplate`
          <form id="register-form" class="space-y-4"> <div> <label for="name" class="block text-sm font-medium mb-1">Full Name</label> ${renderComponent($$result4, "Input", $$Input, {
    "id": "name",
    "name": "name",
    "type": "text",
    "placeholder": "John Doe",
    "required": true
  })} </div> <div> <label for="email" class="block text-sm font-medium mb-1">Email</label> ${renderComponent($$result4, "Input", $$Input, {
    "id": "email",
    "name": "email",
    "type": "email",
    "placeholder": "your@email.com",
    "required": true
  })} </div> <div> <label for="phone" class="block text-sm font-medium mb-1">Phone (optional)</label> ${renderComponent($$result4, "Input", $$Input, {
    "id": "phone",
    "name": "phone",
    "type": "tel",
    "placeholder": "+670 1234567"
  })} </div> <div> <label for="password" class="block text-sm font-medium mb-1">Password <span class="text-muted-foreground">(min 8 characters)</span></label> ${renderComponent($$result4, "Input", $$Input, {
    "id": "password",
    "name": "password",
    "type": "password",
    "placeholder": "••••••••",
    "minLength": 8,
    "required": true
  })} </div> <div> <label for="confirmPassword" class="block text-sm font-medium mb-1">Confirm Password</label> ${renderComponent($$result4, "Input", $$Input, {
    "id": "confirmPassword",
    ...
    "type": "submit",
    "class": "w-full"
  }, { "default": ($$result5) => renderTemplate`Create Account` })} </form>
...
<a href="/login" class="text-primary hover:underline">Sign in</a> </p>
        ` })}
      ` })} </div> </div>
` })} ${renderScript($$result, "/home/jasonwill/dev-projects/timorlist/src/pages/register.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/jasonwill/dev-projects/timorlist/src/pages/register.astro", void 0);
const $$file = "/home/jasonwill/dev-projects/timorlist/src/pages/register.astro";
const $$url = "/register";
