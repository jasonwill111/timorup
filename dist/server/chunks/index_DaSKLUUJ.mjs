...
import { aG as ProviderError, aH as IniSectionType, aI as CONFIG_PREFIX_SEPARATOR, J as readFile, aJ as getConfigFilepath, aK as parseIni, j as getProfileName, C as CredentialsProviderError, s as setCredentialFeature } from "./media_rgSTBrWs.mjs";
import { f as fs } from "./promises_Bc5ugn54.mjs";
import { g as getSSOTokenFilepath, a as getSSOTokenFromFile } from "./getSSOTokenFromFile_5mw9Djnx.mjs";
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
  const { SSOOIDCClient } = await import("./index_z6VsZmad.mjs");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
  const { CreateTokenCommand } = await import("./index_z6VsZmad.mjs");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso_Cm99S80n.mjs");
